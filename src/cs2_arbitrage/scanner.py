...
# dans le navigateur) : limité à Skinport/Waxpeer/CS.Deals, les 3 seules
# sources qui renvoient tout leur catalogue en un appel. Steam et CS.Money
# n'ont pas cet endpoint : leur prix se récupère un item à la fois, avec
# throttle (1.5s / 0.7s) — scanner ~25 000 items dessus prendrait des
# heures. Décision utilisateur du 2026-08-03 : les exclure d'office pour
# cette fonctionnalité plutôt que d'exposer un mode "lent" avec avertissement.
#
...
# navigation ailleurs dans l'app, et la plus complète des 3 (~25 000 items).
# Un item qualifie si son prix Skinport est sous le seuil ; ses prix
# Waxpeer/CS.Deals (jambe de vente potentielle) sont inclus tels quels,
# même au-dessus du seuil. Limite connue : un item absent de Skinport mais
# présent (et bon marché) sur Waxpeer/CS.Deals ne peut jamais qualifier —
# accepté vu que Skinport est déjà la source la plus large des 3.
#
