...
def _mock_all(mock_skinport, mock_waxpeer, mock_csdeals, mock_whitemarket):
...
def test_fetch_scan_prices_skips_low_liquidity_skinport_reference_price(
    mock_skinport, mock_waxpeer, mock_csdeals, mock_whitemarket
):
...
def test_fetch_scan_prices_qualifies_items_by_skinport_price(
    ...
    _mock_all(mock_skinport, mock_waxpeer, mock_csdeals, mock_whitemarket)
